...
export default async function DocumentsPage() {
  ...
  return <AppShell navigation={buildProtectedAppNavigation(access)} topBar={<ContextTopBar title="Documents" secondary="DoorGo document tools"/>}><div className="app-workspace app-workspace-fluid"><section className="grid gap-2 md:grid-cols-2">{DOORGO_DOCUMENT_DEFINITIONS.map((definition) => {

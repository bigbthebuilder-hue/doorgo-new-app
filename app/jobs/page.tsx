  ...
  try {
    ...
    return (
      <AppShell navigation={buildProtectedAppNavigation(access)}>
        <div className="app-workspace max-w-4xl">
          <PageHeader title="Jobs" description="Native DoorGo jobs · hosted persistence"/>
  ...
  return (
    <AppShell navigation={buildProtectedAppNavigation(access)}>
      <div className="app-workspace">
        <PageHeader
          title="Jobs"
          description="Native DoorGo jobs · hosted persistence"

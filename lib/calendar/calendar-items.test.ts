...
const linked=calendarItemCard(row('customer_pickup','2026-08-24'),{internalJobId:'22222222-2222-4222-8222-222222222222',customer:'Authoritative',salesOrder:'999',salesperson:'Blair'});assert.equal(linked.customer,'Authoritative');assert.equal(linked.nativeSalesOrder,'123455');assert.equal(linked.primarySalesOrder,'999');assert.equal(linked.internalJobId,'22222222-2222-4222-8222-222222222222');

...
assert.match(presentation,/key: 'other:notes'.*available: true/);
assert.match(workspace,/checked=\{layer\.available && visible\.includes\(layer\.key\)\} disabled=\{!layer\.available\}/);
assert.match(workspace,/localStorage\.setItem\(layerColorStorageKey/);

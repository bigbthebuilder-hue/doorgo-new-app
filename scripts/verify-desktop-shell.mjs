...
assert.match(standaloneGlass, /showCalculationOutput=\{false\} showCommitActions=\{false\}/, 'Standalone editor must not duplicate output or require an update action');

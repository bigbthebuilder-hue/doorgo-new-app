...
export function JobEditorWorkbenchHarness({ saved = false, lineCount = 1, salesOrder = 'DG-000123' }: { saved?: boolean; lineCount?: number; salesOrder?: string }) {
  ...
  const savedJob = saved ? {
    internalJobId: '11111111-1111-4111-8111-111111111111', doorGoReference: 'DG-000123', bizTrackSalesOrder: salesOrder,
  ...
  return <AppShell hasBottomBar hasTopBar navigation={[]} scrollOwner="workspace"><JobHeaderForm canEdit defaultSalesperson="Barrett" initialDraft={{
    header: { bizTrackSalesOrder: salesOrder, customer: 'Fixture Customer', siteAddress: '123 Fixture Street', salesperson: 'Barrett', phone: '555-0100', email: 'fixture@example.test' },
    lines,
